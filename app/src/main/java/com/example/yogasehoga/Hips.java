...
public class Hips extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hips, container, false);

        recyclerView6 = view.findViewById(R.id.recyclerHipsYoga);
        ...
        db.collection("YogaPose")
                .whereArrayContains("illness", "Hips")
                .get()
