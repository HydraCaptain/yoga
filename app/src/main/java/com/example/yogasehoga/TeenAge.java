...
public class TeenAge extends Fragment {
    RecyclerView recyclerViewTeenage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_teen_age, container, false);

        recyclerViewTeenage = view.findViewById(R.id.recyclerTeenageYoga);
        recyclerViewTeenage.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        recyclerViewTeenage.setAdapter(adapter);

        db = FirebaseFirestore.getInstance();

        db.collection("YogaPose")
                .whereArrayContains("ageGroup", "15-27")
                .get()
