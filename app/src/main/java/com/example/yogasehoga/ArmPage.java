...
public class ArmPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_arm_page, container, false);

        recyclerView1 = view.findViewById(R.id.recyclerArmYoga);
        ...
        db.collection("YogaPose")
                .whereArrayContains("illness", "Arm")
                .get()
