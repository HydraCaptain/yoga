...
public class Ankle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ankle, container, false);

        recyclerView2 = view.findViewById(R.id.recyclerAnkleYoga);
        ...
        db.collection("YogaPose")
                .whereArrayContains("illness", "Ankle")
                .get()
